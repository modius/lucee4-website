						...
						<ul class="listing border-light">
							...
							<li class="listing-item thumb-large">
								...
								<div class="listing-content">
									...
									<p>Warning! If you have installed Lucee on a public server you need to secure the <a href="#serverAdminURL#	">Server</a> and <a href="#webAdminURL#	">Web</a> admins OF EVERY CONTEXT with appropriate passwords or other access restrictions. In addition you should set a default password in the Server admin for all web admins to be sure they are protected by default</p>
